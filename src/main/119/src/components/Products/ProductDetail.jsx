...
const ProductDetail = ({ addCart }) => {
    ...
    const handleAddToCart = () => {
        addCart({ ...productDetailData, quantity: quantity });
        setQuantity(1);
    };
    ...
    let discountedPrice = productDetailData.product_price;
    if (productDetailData.promotion_discount) {
        discountedPrice = Math.floor(productDetailData.product_price - (productDetailData.product_price * productDetailData.promotion_discount / 100));
    }
